...
describe('UserController', () => {
  ...
  it('should create a user', async () => {
    ...
    vi.mocked(mockUserUseCase.createUser).mockResolvedValue(user)
  ...
  it('should get user by id', async () => {
    ...
    vi.mocked(mockUserUseCase.getUserById).mockResolvedValue(user)
  ...
  it('should return 404 when user not found', async () => {
    vi.mocked(mockUserUseCase.getUserById).mockResolvedValue(null)
